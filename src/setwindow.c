	...
	while(1)
	{
		...
		if(re_show)
		{
			...
			DrawHZText12(msg,0,set_offset,y_offset+line_x*3,gl_color_selected,1);
                ...
                Draw_select_icon(x_offset+12*5+16,y_offset+line_x*3,(language_sel == 2));
                ...
                DrawHZText12(msg,0,x_offset+12*5+24,y_offset+line_x*3,(language_sel==2)?gl_color_selected:gl_color_text,1);
